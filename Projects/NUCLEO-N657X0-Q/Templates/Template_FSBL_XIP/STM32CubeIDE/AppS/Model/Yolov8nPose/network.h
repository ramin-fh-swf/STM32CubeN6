...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "Yolov8nPose"
...
// Output buffer 1 -- Transpose_627_out_0
#define LL_ATON_DEFAULT_OUT_1_ALIGNMENT   (32)
#define LL_ATON_DEFAULT_OUT_1_SIZE_BYTES  (117600)
