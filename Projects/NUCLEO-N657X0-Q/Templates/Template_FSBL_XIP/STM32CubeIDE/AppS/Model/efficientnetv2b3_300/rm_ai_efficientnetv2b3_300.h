...
#define MODEL_ACTIVATIONS_SIZE_MB   (1.545f)   /* (inkl. I/O-Buffer in activations) */
#define MODEL_MEMORY_USAGE_TOTAL_MB (17.931f)
...
#define MODEL_ACTIVATIONS_PLACEMENT "SRAM (CPU-RAM: -; NPU-RAM: AXISRAM3, AXISRAM4, AXISRAM5 and AXISRAM6)"
