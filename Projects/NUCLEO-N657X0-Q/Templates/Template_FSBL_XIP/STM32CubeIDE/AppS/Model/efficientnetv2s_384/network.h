...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "efficientnetv2s_384_int8_1"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (442368)

/************************** OUTPUTS *******************************************/
#define LL_ATON_DEFAULT_OUT_NUM        (1)    // Total number of output buffers
// Output buffer 1 -- Dequantize_1285_out_0
